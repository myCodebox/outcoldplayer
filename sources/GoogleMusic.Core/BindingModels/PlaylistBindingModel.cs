...
namespace OutcoldSolutions.GoogleMusic.BindingModels
{
    ...
    {
        private static readonly Lazy<IPlaylistsService> PlaylistsService = new Lazy<IPlaylistsService>(() => ApplicationContext.Container.Resolve<IPlaylistsService>());
        private static readonly Lazy<ILogger> Logger = new Lazy<ILogger>(() => ApplicationContext.Container.Resolve<ILogManager>().CreateLogger("PlaylistBindingModel"));
        private static readonly Lazy<IDispatcher> Dispatcher = new Lazy<IDispatcher>(() => ApplicationContext.Container.Resolve<IDispatcher>()); 
