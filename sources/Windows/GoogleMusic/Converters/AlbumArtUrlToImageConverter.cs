...
namespace OutcoldSolutions.GoogleMusic.Converters
{
    ...
    public class AlbumArtUrlToImageConverter : IValueConverter
    {
        ...
        private readonly Lazy<ILogger> logger = new Lazy<ILogger>(() => ApplicationContext.Container.Resolve<ILogManager>().CreateLogger("AlbumArtUrlToImageConverter"));
        private readonly Lazy<IAlbumArtCacheService> cacheService = new Lazy<IAlbumArtCacheService>(() => ApplicationContext.Container.Resolve<IAlbumArtCacheService>());
