...
namespace OutcoldSolutions.GoogleMusic.Web
{
    ...
    public interface IWindowsStoreStream : IStream
    {
        IRandomAccessStream Stream { get; }
    }

    public class WindowsStoreStream : IWindowsStoreStream
    {
        public WindowsStoreStream(IRandomAccessStream stream)
        {
            this.Stream = stream;
        }
    ...
    public class MediaStreamDownloadService : IMediaStreamDownloadService
    {
        ...
        public async Task<IStream> GetCachedStreamAsync(IFile file, CancellationToken token)
        {
            ...
            return new WindowsStoreStream(memoryRandomAccessStream);
        }
        ...
        private class MemoryRandomAccessStream : INetworkRandomAccessStream, IRandomAccessStream, IWindowsStoreStream
        {
            private readonly ILogger logger;
            ...
            public async Task SaveToFileAsync(IFile file)
            {
        ...
        private class MemoryRandomAccessStreamMultiStreams : INetworkRandomAccessStream, IRandomAccessStream, IWindowsStoreStream
        {
            private readonly SemaphoreSlim semaphore = new SemaphoreSlim(1);
