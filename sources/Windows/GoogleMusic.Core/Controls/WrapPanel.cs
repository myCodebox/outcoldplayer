...
namespace OutcoldSolutions.GoogleMusic.Controls
{
    ...
    public class WrapPanel : Panel
    {
        ...
        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly",
            Justification = "Almost always set from the CLR property.")]
    ...
    internal static class NumericExtensions
    {
        ...
        private struct NanUnion
        {
            ...
            [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields",
                Justification = "It is accessed through the other member of the union")]
            [FieldOffset(0)]
        ...
        public static bool AreClose(double left, double right)
        {
            ...
            if (left == right) // ReSharper restore CompareOfFloatsByEqualityOperator
            {
                return true;
            }
