...
// --------------------------------------------------------------------------------------------------------------------
namespace OutcoldSolutions.GoogleMusic.Suites.Presentation.Converters
{
    using System;

    using NUnit.Framework;

    using OutcoldSolutions.GoogleMusic.Presentation.Converters;

    using Windows.UI.Xaml;

    public class BooleanToVisibilityConverterSuites : SuitesBase
    {
