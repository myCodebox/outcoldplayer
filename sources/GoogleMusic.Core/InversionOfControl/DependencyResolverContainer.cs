    ...
    public class DependencyResolverContainer : IDependencyResolverContainer
    {
        ...
        public IRegistrationContext Registration()
        {
            ...
            lock (this.registractionContextLocker)
            {
                ...
                throw new NotSupportedException("Previous created registration context is not disposed.");
            }
        }
        ...
        public object Resolve(Type type, params object[] arguments)
        {
            ...
            throw new ArgumentOutOfRangeException(
                "type",
                string.Format(CultureInfo.CurrentCulture, "Type '{0}' is not registered.", type));
        }
            ...
            lock (this.registractionContextLocker)
            {
                if (this.currentRegistrationContext == null)
                {
                    throw new NotSupportedException(
                        "Container is not in registration mode. User Register() method to block container for registration.");
                }
            ...
            if (this.isDisposed)
            {
                if (this.containerContext != null)
                {
                    var errMessage = string.Format(
                        ...
                        "Container with context '{0}' is disposed.",
